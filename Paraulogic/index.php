...
/*escollir seed depenent del dia*/
function getSeed($data){
    $data=strtotime($data);
    return $data;
}

/*funcio que treu 7 caracter aleatoris de dintre l'array*/
function caracterAleatori(){
    $abecedari= ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z","_"];
    for($i=0;$i<7;$i++){
        $lletres[]=$abecedari[rand()%26];
    }
    $lletres=array();
    $_SESSION['lletra']=$lletres;
}

/*Agafa totes les funcions de php per defecte*/
...
$rebre_dades = ( $_SERVER['REQUEST_METHOD'] == 'POST' );

if($rebre_dades){

    $respostes=$_REQUEST['respostes'];
    header("Location: process.php?respostes=$respostes");
...
<form name="para" class="paraulogic" action="index.php" method="post">
<div class="main">
    <h1>
    ...
    <!--<div class="container-notifications">
        ...
        <div class="container-hexgrid">
            <ul id="hex-grid">
                <li class="hex">
                    <div class="hex-in"><a class="hex-link" data-lletra=<?php echo $_SESSION['lletra'][0]; ?> draggable="false"><p><?php echo $_SESSION['lletra'][0]; ?></p></a></div>
                </li>
                <li class="hex">
                    <div class="hex-in"><a class="hex-link" data-lletra=<?php echo $_SESSION['lletra'][1]; ?>  draggable="false"><p><?php echo $_SESSION['lletra'][1]; ?></p></a></div>
                </li>
                <li class="hex">
                    <div class="hex-in"><a class="hex-link" data-lletra=<?php echo $_SESSION['lletra'][2]; ?>  draggable="false"><p><?php echo $_SESSION['lletra'][2]; ?></p></a></div>
                </li>
                <li class="hex">
                    <div class="hex-in"><a class="hex-link" data-lletra=<?php echo $_SESSION['lletra'][3]; ?>  draggable="false" id="center-letter"><p><?php echo $_SESSION['lletra'][3]; ?></p></a></div>
                </li>
                <li class="hex">
                    <div class="hex-in"><a class="hex-link" data-lletra=<?php echo $_SESSION['lletra'][4]; ?>  draggable="false"><p><?php echo $_SESSION['lletra'][4]; ?></p></a></div>
                </li>
                <li class="hex">
                    <div class="hex-in"><a class="hex-link" data-lletra=<?php echo $_SESSION['lletra'][5]; ?>  draggable="false"><p><?php echo $_SESSION['lletra'][5]; ?></p></a></div>
                </li>
                <li class="hex">
                    <div class="hex-in"><a class="hex-link" data-lletra=<?php echo $_SESSION['lletra'][6]; ?>  draggable="false"><p><?php echo $_SESSION['lletra'][6]; ?></p></a></div>
                </li>
            </ul>
        </div>
